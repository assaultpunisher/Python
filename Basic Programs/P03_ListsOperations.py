...
# To pop last element
print('\nPopped Element:', myList.pop())

# To remove a particular element from the list BY NAME
myList.remove(6)
print('\nAfter removing \'6\':', myList)

# To insert an element at a specified Index
myList.insert(5, 6)
print('\nInserting \'6\' at 5th index:', myList)

# To count number of occurrences of a element in the list
print('No of Occurrences of \'1\':', myList.count(1))

# To extend a list that is insert multiple elements at once at the end of the list
myList.extend([11, 0])
print('\nExtending list:', myList)
